...
NAME = "acc-test-7-readiness-probe"
NAMESPACE = "default"
ALERT = (
    "Deployment acc-test-7-readiness-probe in namespace default is unavailable because its pod is not ready. "
    "Investigate the real Kubernetes state and determine the cause."
)
...
try:
    print("GROUND_TRUTH_BEFORE:", json.dumps(ground_truth()))
    ...
    print("GROUND_TRUTH_AFTER:", json.dumps(ground_truth()))